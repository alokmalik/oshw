...
sleep 1 
#modify line below
#1. keep depth at 50% deadlock for 10 customers
# add to code to make multiple customers 
...
echo " "
echo "DON'T LEAVE SHM OR SEMS BEHIND"
ipcs
echo "USE THE ipcrm COMMAND TO REMOVE THEM"
echo " "
